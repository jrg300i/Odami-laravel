...
@section('title', 'Editar Trabajo - Tapicería Odami')
...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('trabajos.show', $trabajo) }}" class="btn btn-secondary">
                ...
                <form action="{{ route('trabajos.update', $trabajo) }}" method="POST">
                                ...
                                <select name="cliente_id" id="cliente_id" class="form-select @error('cliente_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($clientes as $cliente)
                                        <option value="{{ $cliente->id }}" 
                                                {{ old('cliente_id', $trabajo->cliente_id) == $cliente->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="tipo" id="tipo" class="form-select @error('tipo') is-invalid @enderror" required>
                                    ...
                                    <option value="silla" {{ old('tipo', $trabajo->tipo) == 'silla' ? 'selected' : '' }}>Silla</option>
                                    <option value="sofa" {{ old('tipo', $trabajo->tipo) == 'sofa' ? 'selected' : '' }}>Sofá</option>
                                    <option value="sillon" {{ old('tipo', $trabajo->tipo) == 'sillon' ? 'selected' : '' }}>Sillón</option>
                                    <option value="cabecero" {{ old('tipo', $trabajo->tipo) == 'cabecero' ? 'selected' : '' }}>Cabecero</option>
                                    <option value="butaca" {{ old('tipo', $trabajo->tipo) == 'butaca' ? 'selected' : '' }}>Butaca</option>
                                    <option value="personalizado" {{ old('tipo', $trabajo->tipo) == 'personalizado' ? 'selected' : '' }}>Personalizado</option>
                                </select>
                                @error('tipo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="descripcion" 
                                  ...
                                  rows="3" 
                                  placeholder="Descripción detallada del trabajo a realizar...">{{ old('descripcion', $trabajo->descripcion) }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select name="estado" id="estado" class="form-select @error('estado') is-invalid @enderror" required>
                                    <option value="presupuesto" {{ old('estado', $trabajo->estado) == 'presupuesto' ? 'selected' : '' }}>Presupuesto</option>
                                    ...
                                    <option value="entregado" {{ old('estado', $trabajo->estado) == 'entregado' ? 'selected' : '' }}>Entregado</option>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('costo_estimado', $trabajo->costo_estimado) }}" 
                                       step="0.01" 
                                       min="0" 
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select name="prioridad" id="prioridad" class="form-select @error('prioridad') is-invalid @enderror" required>
                                    <option value="1" {{ old('prioridad', $trabajo->prioridad) == '1' ? 'selected' : '' }}>⭐ Muy Baja</option>
                                    <option value="2" {{ old('prioridad', $trabajo->prioridad) == '2' ? 'selected' : '' }}>⭐⭐ Baja</option>
                                    <option value="3" {{ old('prioridad', $trabajo->prioridad) == '3' ? 'selected' : '' }}>⭐⭐⭐ Media</option>
                                    <option value="4" {{ old('prioridad', $trabajo->prioridad) == '4' ? 'selected' : '' }}>⭐⭐⭐⭐ Alta</option>
                                    <option value="5" {{ old('prioridad', $trabajo->prioridad) == '5' ? 'selected' : '' }}>⭐⭐⭐⭐⭐ Muy Alta</option>
                                </select>
                                @error('prioridad')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('fecha_inicio', $trabajo->fecha_inicio?->format('Y-m-d')) }}">
                                @error('fecha_inicio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('fecha_fin_estimada', $trabajo->fecha_fin_estimada?->format('Y-m-d')) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" 
                                           ...
                                           id="urgente" 
                                           value="1" 
                                           {{ old('urgente', $trabajo->urgente) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="observaciones_cliente" 
                                  ...
                                  rows="2" 
                                  placeholder="Observaciones o requisitos específicos del cliente...">{{ old('observaciones_cliente', $trabajo->observaciones_cliente) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="notas_internas" 
                                  ...
                                  rows="3" 
                                  placeholder="Notas internas para el equipo de trabajo...">{{ old('notas_internas', $trabajo->notas_internas) }}</textarea>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('trabajos.show', $trabajo) }}" class="btn btn-secondary me-md-2">
                            <i class="fas fa-times me-2"></i>Cancelar
                        </a>
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Actualizar Trabajo
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <p class="text-muted small mb-3">
                    Puedes asignar materiales a este trabajo. Los materiales se pueden agregar o modificar después.
                </p>
                            ...
                            <div class="mb-2">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="0" 
                                           step="0.01"
                                           value="{{ old('materiales.' . $material->id, $trabajo->materiales->find($material->id)?->pivot->cantidad) }}">
        ...
        <div class="card shadow mt-4">
            ...
            <div class="card-body">
                <dl class="row mb-0">
                    ...
                    <dd class="col-7">{{ $trabajo->codigo_trabajo }}</dd>
                    
                    <dt class="col-5 text-muted">Creado:</dt>
                    <dd class="col-7">{{ $trabajo->created_at->format('d/m/Y H:i') }}</dd>
                    
                    <dt class="col-5 text-muted">Última Actualización:</dt>
                    <dd class="col-7">{{ $trabajo->updated_at->format('d/m/Y H:i') }}</dd>

                    @if($trabajo->fecha_fin_real)
                        <dt class="col-5 text-muted">Fecha Fin Real:</dt>
                        <dd class="col-7">{{ $trabajo->fecha_fin_real->format('d/m/Y') }}</dd>
                    @endif
                </dl>
            </div>
        </div>
